...
def lstm_model(input_shape):
   ...
   num_classes = 9    # num of classes for ecg output
   model = Sequential()
...
def train():
   ...
   pickle_in = open("data_pickles/Ant-v1_4joints20diff1000doverse1.dict", "rb")
   ...
   model.save('saved_models/my_modelant4jointsday31_eff_div.h5')
